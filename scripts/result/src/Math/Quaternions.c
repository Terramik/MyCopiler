...
Quaterniontype Quaternion = (Quaterniontype){};Quaternioninstance __init__g_a38b15a4cbfe464fb7749c48ab8dbc30(double w,double x,double y,double z,void* _env){Quaternioninstance self = (Quaternioninstance){};{((self).w)=(w);
((self).x)=(x);
((self).y)=(y);
((self).z)=(z);
return self;
...
}double normg(Quaternioninstance self__0b3c5a5e8ebe4f7ba6b97da6d9d42903,void* _env){return ((sqrt_our).func)((((((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).x)*((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).x))+(((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).y)*((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).y)))+(((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).z)*((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).z)))+(((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).w)*((self__0b3c5a5e8ebe4f7ba6b97da6d9d42903).w)),(sqrt_our).env);
}Quaternioninstance normalizeg(Quaternioninstance self__4a9116b6e69f4958b721c3d10279072e,void* _env){double norm_;
(norm_)=((((Quaternion).norm).func)(self__4a9116b6e69f4958b721c3d10279072e,((Quaternion).norm).env));
if ((((abs_our).func)(norm_,(abs_our).env))>(1e-6)){(norm_)=(((double)(1))/(norm_));
return (((Quaternion).__init__).func)(((self__4a9116b6e69f4958b721c3d10279072e).w)*(norm_),((self__4a9116b6e69f4958b721c3d10279072e).x)*(norm_),((self__4a9116b6e69f4958b721c3d10279072e).y)*(norm_),((self__4a9116b6e69f4958b721c3d10279072e).z)*(norm_),((Quaternion).__init__).env);
}else{}return self__4a9116b6e69f4958b721c3d10279072e;
}Quaternioninstance conjg(Quaternioninstance self__9f0fcdf6eb244c88905eb3b2f87570d4,void* _env){return (((Quaternion).__init__).func)((self__9f0fcdf6eb244c88905eb3b2f87570d4).w,-((self__9f0fcdf6eb244c88905eb3b2f87570d4).x),-((self__9f0fcdf6eb244c88905eb3b2f87570d4).y),-((self__9f0fcdf6eb244c88905eb3b2f87570d4).z),((Quaternion).__init__).env);
...
}void to_vectorg(Quaternioninstance self__bf45bebbb6d64c5284c2a1605963b539,doubles1 vec_,void* _env){(vec_.start[doubles1i(vec_, (uint64_t)(0), "81:12-81:13")])=((self__bf45bebbb6d64c5284c2a1605963b539).x);
(vec_.start[doubles1i(vec_, (uint64_t)(1), "82:12-82:13")])=((self__bf45bebbb6d64c5284c2a1605963b539).y);
(vec_.start[doubles1i(vec_, (uint64_t)(2), "83:12-83:13")])=((self__bf45bebbb6d64c5284c2a1605963b539).z);
}void applyg(Quaternioninstance self__b37dc8e8344a4edaba57e99899ecf4e3,doubles1 vec__8d14f506e4cb415093af0d8c41356dc4,void* _env){Quaternioninstance q;
((assert_our).func)(((vec__8d14f506e4cb415093af0d8c41356dc4)._0)==(3),c_str_to_slise("Bad vector", 10),(assert_our).env);
(q)=((((Quaternion).from_vector).func)(vec__8d14f506e4cb415093af0d8c41356dc4,((Quaternion).from_vector).env));
(q)=((((Quaternion).__mul__).func)((((Quaternion).__mul__).func)(self__b37dc8e8344a4edaba57e99899ecf4e3,q,((Quaternion).__mul__).env),(((Quaternion).conj).func)(self__b37dc8e8344a4edaba57e99899ecf4e3,((Quaternion).conj).env),((Quaternion).__mul__).env));
(((Quaternion).to_vector).func)(q,vec__8d14f506e4cb415093af0d8c41356dc4,((Quaternion).to_vector).env);
